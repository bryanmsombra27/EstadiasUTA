        ...
        <form action="#" class="register__form">
            ...
            <div class="register-field">
                <div class="input-container">
                    <label class="register-label" for="matricula">Matricula</label>
                    <input class="register__input" type="text" id="matricula">
                </div>
            </div>
            <input type="file" name="" id="" class="register__image">
