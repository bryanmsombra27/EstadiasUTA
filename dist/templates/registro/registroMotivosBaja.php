    ...
    <header class="header">
        <div class="header-container">
            ...
            <div class="header__text-container">
                <h1 class="title">Registro Motivos de Bajas de Alumnos</h1>
            </div>
    </header>
    ...
    <section class="register-career container">
        <form action="#" class="register__form" id="register-form">
            ...
            <div class="input-container ">
                <label class="register-label" for="motivo">Motivo</label>
                <textarea class="register__input " type="text" id="motivo"></textarea>
            </div>



            <input class="register__input--submit top" type="submit" value="Registrar">
        </form>
