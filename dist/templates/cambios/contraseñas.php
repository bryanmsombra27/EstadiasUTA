        ...
        <form action="#" class="register__form" id="register-form">
            <div class="register-field">
                <div class="input-container">
                    <label class="register-label" for="periodo">Antigua Contraseña</label>
                    <input class="register__input" type="text" id="periodo" name="periodo">
                </div>

                <div class="input-container">
                    <label class="register-label" for="cuatrimestre">Confirme Antigua Contraseña</label>
            ...
            <div class="register-field">
                <div class="input-container">
                    <label class="register-label" for="periodo">Nueva Contraseña</label>
                    <input class="register__input" type="text" id="periodo" name="periodo">
                </div>

                <div class="input-container">
                    <label class="register-label" for="cuatrimestre">Confirme Nueva Contraseña</label>
                    <input class="register__input" type="text" id="cuatrimestre" name="cuatrimeste">
                </div>
