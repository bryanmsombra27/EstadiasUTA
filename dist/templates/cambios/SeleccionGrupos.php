    ...
    <header class="header">
        <div class="header-container">
            ...
            <div class="header__text-container">
                <h1 class="">Selección de Grupo</h1>
            </div>
    </header>
    ...
    <section class="register-career container">
        <form action="#" class="register__form">
            ...
            <div class="register-field">
                ...
                <div class="input-container">
                    <label class="register-label" for="director">Turno</label>
                    <select name="" id="" class="register__input">
                        <option value="uta">Matutino</option>
                    </select>
                </div>
            </div>

            <input class="register__input--submit" type="submit" value="Consultar Datos">
        </form>
