    ...
    <div class="table-container container">
        <table class="table__size">
            ...
            <tbody class="table__content">
                ...
                <tr class="table__row2">
                    <td class="table__item">201804094</td>
                    <td class="table__item">Bailon Nova Annel</td>
                    <td class="table__item"></td>
                    <td class="table__item--actions">
                        <a href="#" class="table__item--delete">Extraordinario</a>
                    </td>
                </tr>
